...
function Header() {
  return (
    <header className="h-16 w-screen sticksy top-0 left-0 z-50 bg-gray-400/10">
      <nav className="h-full flex items-center justify-between px-5">
        {/* left */}
        <div className="center-div">
          <IoMenu className="size-6 mr-2" />
          <div className="center-div">
        ...
        <div className="center-div gap-3">
          <div className="center-div gap-1 bg-gray-900/30 text-white px-3 py-2 rounded-full cursor-pointer">
          ...
          <img
            src={profile}
            className="size-10 rounded-full object-center aspect-square"
            alt=""
          />
        </div>
      </nav>
